...
# Setup common infrastructure
  ...
  az_spoke_db_client_subnet		= var.az_spoke_db_client_subnet
  az_spoke_db_client_subnet_prefix	= var.az_spoke_db_client_subnet_prefix
  az_spoke_db_admin_subnet		= var.az_spoke_db_admin_subnet
  az_spoke_db_admin_subnet_prefix	= var.az_spoke_db_admin_subnet_prefix 
