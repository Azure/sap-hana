locals {
    ...
    sa_sapbits_name                     = local.sa_sapbits_exists ? try(var.storage_account_sapbits.Storage_account_name, "") : "sapbits${random_id.random-id.hex}"
    ...
    sa_tfstate_name                     = local.sa_sapbits_exists ? try(var.storage_account_tfstate.Storage_account_name, "") : "tfstate${random_id.random-id.hex}"
