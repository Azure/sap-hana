...
resource "azurerm_virtual_machine_extension" "web_linux_extension" {
  provider             = azurerm.main
  count                = local.enable_deployment ? (upper(local.scs_ostype) == "LINUX" ? local.webdispatcher_count : 0) : 0
