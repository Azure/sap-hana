...
locals {
  ...
  iscsi_count = lookup(var.infrastructure, "iscsi", {}) != {} && (length(local.hana-databases) > 0 ? (local.hdb_ha && try(upper(local.hdb_os.publisher) == "SUSE", false)) : false) ? var.infrastructure.iscsi.iscsi_count : 0
