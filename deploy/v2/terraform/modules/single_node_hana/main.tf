...
module "common_infrastructure" {
  ...
  sap_admin_subnet_existing    = var.infrastructure.vnets.sap.db_admin_subnet.is_existing
  sap_admin_subnet_name        = var.infrastructure.vnets.sap.db_admin_subnet.name
  sap_admin_subnet_prefix      = var.infrastructure.vnets.sap.db_admin_subnet.prefix
  sap_client_subnet_existing   = var.infrastructure.vnets.sap.db_client_subnet.is_existing
  sap_client_subnet_name       = var.infrastructure.vnets.sap.db_client_subnet.name
  sap_client_subnet_prefix     = var.infrastructure.vnets.sap.db_client_subnet.prefix
  ...
  sap_admin_nsg_existing       = var.infrastructure.vnets.sap.db_admin_subnet.nsg.is_existing
  sap_admin_nsg_name           = var.infrastructure.vnets.sap.db_admin_subnet.nsg.name
  sap_client_nsg_existing      = var.infrastructure.vnets.sap.db_client_subnet.nsg.is_existing
  sap_client_nsg_name          = var.infrastructure.vnets.sap.db_client_subnet.nsg.name
